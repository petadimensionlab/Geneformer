...
Design:
  ...
  filter_data  = blood immune-cell pool + one timepoint at a time:
  ...
  Timepoints evaluated SEPARATELY (3m / 4.5m / 6m / 9m / 12m) and compared, so
  the user can rank genes by how strongly they act at the EARLIEST timepoint
